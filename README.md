...
<head>
  ...
  <title>RuneTunes | Mythwave Codex</title>
  <style>
    body {
      margin: 0;
      font-family: 'Orbitron', sans-serif;
      background: linear-gradient(135deg, #0a0f1c, #1a2135);
      color: #f4f4f4;
    }
    header {
      background: #101622;
    ...
    .hero {
      text-align: center;
      padding: 4rem 2rem;
      background: radial-gradient(#111827, #0a0f1c);
    }
    .hero h2 {
      font-size: 2.5rem;
...
<body>
  ...
  <section class="section" id="volumes">
